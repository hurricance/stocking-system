...
document.getElementById('dataForm').addEventListener('submit', function(event) {
    ...
    const data = {
                ...
                total_stocking_quantity: formData.get('total_stocking_quantity'),
                total_forSale_quantity: formData.get('total_forSale_quantity'),
...
// document.getElementById('dataForm').addEventListener('searchButton', function(event) {//按钮id
//     event.preventDefault(); // 阻止默认的表单提交行为
